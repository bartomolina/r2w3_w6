...
import { Input, Tooltip, Alert, Button, Col, Menu, Row, List } from "antd";
...
function App(props) {
  ...
  // ** keep track of the reward per block
          ...
          <Route exact path="/">
            ...
            <div style={{ padding: 8 }}>
              <Button
                type={"default"}
                onClick={() => {
                  tx(writeContracts.Staker.restake());
                }}
              >
                ↪️ Restake!
              </Button>
